...
let {name,date,location,id,numberOfTickets} = useLocation().state
date = new Date(date);
...
let setEventsData = ()=>
  ...
  <Box className="bottomMargindot5rem eventDetailTime" justify="start" align="center" direction="row"  ><Calendar  color='grey' />{date}</Box> 
  <Box className="marginBottom1rem eventDetailTime" justify="start" align="center" direction="row" ><Location  color='grey' />{location}</Box> 
        ...
        <div className="eventDetailBackground" />
          ...
          <Text className="eventTicketText" size="large" weight="bold">Tickets</Text>
